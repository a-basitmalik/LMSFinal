                    ...
                    child: Padding(
                      ...
                      child: TableCalendar(
                        ...
                        calendarStyle: CalendarStyle(
                          defaultTextStyle: AdminTextStyles.cardSubtitle
                              .copyWith(
                            color: AdminColors.primaryText,
                          ),
                          weekendTextStyle: AdminTextStyles.cardSubtitle
                              .copyWith(
                            color: AdminColors.primaryText,
                          ),
                          outsideTextStyle: AdminTextStyles.cardSubtitle
                              .copyWith(
                        ...
                        headerStyle: HeaderStyle(
                          ...
                          formatButtonTextStyle: AdminTextStyles.secondaryButton
                              .copyWith(
                            color: AdminColors.primaryText,
                          ),
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'PLANNERS ON ${DateFormat('MMMM d, y').format(
                                _selectedDay!)}',
          ...
          child: InkWell(
            ...
            onTap: () {
              Navigator.push(
                ...
                // Refresh the calendar when returning from detail screen
                _fetchPlanners();
              });
            },
            child: Container(
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        if (planner.hasPoints) ...[
                          const SizedBox(height: 4),
                          Text(
                            '${planner.pointsList.length} lesson points',
                            style: AdminTextStyles.cardSubtitle.copyWith(
